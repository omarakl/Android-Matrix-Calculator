...
public class calculate_result_4x4_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_calculate_result_4x4_1);
        getSupportActionBar().hide();

        a = (EditText) findViewById(R.id.w1);
        b = (EditText) findViewById(R.id.w2);
        c = (EditText) findViewById(R.id.w3);
        d = (EditText) findViewById(R.id.w4);
        e = (EditText) findViewById(R.id.w5);
        f = (EditText) findViewById(R.id.w6);
        g = (EditText) findViewById(R.id.w7);
        h = (EditText) findViewById(R.id.w8);
        i = (EditText) findViewById(R.id.w9);
        j = (EditText) findViewById(R.id.w10);
        k = (EditText) findViewById(R.id.w11);
        l = (EditText) findViewById(R.id.w12);
        m = (EditText) findViewById(R.id.w13);
        n = (EditText) findViewById(R.id.w14);
        o = (EditText) findViewById(R.id.w15);
        p = (EditText) findViewById(R.id.w16);
