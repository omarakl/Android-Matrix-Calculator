...
public class inverse_result_3x3_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inverse_result_3x3_1);
        getSupportActionBar().hide();

        a = (EditText) findViewById(R.id.cx1);
        b = (EditText) findViewById(R.id.cx2);
        c = (EditText) findViewById(R.id.cx3);
        d = (EditText) findViewById(R.id.cx4);
        e = (EditText) findViewById(R.id.cx5);
        f = (EditText) findViewById(R.id.cx6);
        g = (EditText) findViewById(R.id.cx7);
        h = (EditText) findViewById(R.id.cx8);
        i = (EditText) findViewById(R.id.cx9);
