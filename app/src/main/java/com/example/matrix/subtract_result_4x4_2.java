...
public class subtract_result_4x4_2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_subtract_result_4x4_2);
        getSupportActionBar().hide();


        a = (EditText) findViewById(R.id.qq1);
        b = (EditText) findViewById(R.id.qq2);
        c = (EditText) findViewById(R.id.qq3);
        d = (EditText) findViewById(R.id.qq4);
        e = (EditText) findViewById(R.id.qq5);
        f = (EditText) findViewById(R.id.qq6);
        g = (EditText) findViewById(R.id.qq7);
        h = (EditText) findViewById(R.id.qq8);
        i = (EditText) findViewById(R.id.qq9);
        j = (EditText) findViewById(R.id.qq10);
        k = (EditText) findViewById(R.id.qq11);
        l = (EditText) findViewById(R.id.qq12);
        m = (EditText) findViewById(R.id.qq13);
        n = (EditText) findViewById(R.id.qq14);
        o = (EditText) findViewById(R.id.qq15);
        p = (EditText) findViewById(R.id.qq16);
